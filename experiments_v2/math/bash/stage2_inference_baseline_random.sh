...
python experiments_v2/math/run_stage2_inference_baseline.py \
    ...
    --output_file result_v2/math/baseline/random_graph/gpt5mini/test_results.json \
    --random_graph \
...
python experiments_v2/math/run_stage2_inference_baseline.py \
    --test_file Datasets/MATH/math_test.jsonl \
    --output_file result_v2/math/baseline/random_graph/qwen3_80b/test_results.json \
    --random_graph \
